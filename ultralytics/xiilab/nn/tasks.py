...
from ultralytics.xiilab.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
class BaseModel(nn.Module):
    ...
    def forward(self, x, xii,*args, **kwargs):
        """
        ...
        if isinstance(x, dict):  # for cases of training and validating while training.
            if xii :
                return self.loss(x, xii, *args, **kwargs)
            if not xii :
                return self.loss(x, xii, *args, **kwargs)
    ...
    def loss(self, batch, preds=None, xii=False):
        """
        Compute loss.
        ...
        if preds == None :
            ...
            if self.do_feat_loss:
                ...
                return (self.ori_loss[0] + self.mask_loss[0] - feat_loss[0] * 0.5 - reverse_feat_loss[0] * 0.3, \
                         self.ori_loss[1] + self.mask_loss[1])
            else:
